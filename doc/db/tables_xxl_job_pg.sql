-- xxl-job适配PostgreSQL数据库 https://blog.csdn.net/sadoshi/article/details/120341542
...
comment on table public.xxl_job_info is '任务信息表';
comment on column public.xxl_job_info.id  is '主键';
comment on column public.xxl_job_info.job_group  is '执行器主键ID';
comment on column public.xxl_job_info.job_desc  is '任务描述';
comment on column public.xxl_job_info.add_time  is '任务创建时间';
comment on column public.xxl_job_info.update_time  is '任务更新时间';
...
comment on table public.xxl_job_log is '任务日志表';
comment on column public.xxl_job_log.id  is '主键';
...
create trigger t_xxl_job_logglue_update_time before update on public.xxl_job_logglue for each row execute procedure upd_timestamp();
comment on table public.xxl_job_logglue is '任务GLUE日志表';
comment on column public.xxl_job_logglue.id  is '主键';
...
comment on column public.xxl_job_logglue.add_time  is '创建时间';
comment on column public.xxl_job_logglue.update_time  is '修改时间';
...
comment on column  public.xxl_job_log_report.id  is '主键';
...
comment on table public.xxl_job_registry is '任务注册表';
comment on column public.xxl_job_registry.id  is '主键';
comment on column public.xxl_job_registry.registry_group  is '注册分组';
comment on column public.xxl_job_registry.registry_key  is '注册键';
comment on column public.xxl_job_registry.registry_value  is '注册值';
comment on column public.xxl_job_registry.update_time  is '更新时间';
...
comment on table public.xxl_job_group is '任务分组表';
comment on column public.xxl_job_group.id  is '主键';
...
comment on table public.xxl_job_user is '任务用户表';
comment on column public.xxl_job_user.id  is '主键';
...
comment on table public.xxl_job_lock is '任务锁表';
comment on column public.xxl_job_lock.lock_name  is '锁名称';



INSERT INTO  public.xxl_job_group ( id ,  app_name ,  title ,  address_type ,  address_list ) VALUES (1, 'xxl-job-executor-sample', '示例执行器', 0, NULL);
